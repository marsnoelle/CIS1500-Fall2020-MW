...
public class Project4 {
    public static void main(String[] args) {
        System.out.println("0 of 9 tests passed");

        testAdditionSmallNumbersSameSignsPositive();
        System.out.println("1 of 9 tests passed");

        testAdditionSmallNumbersSameSignsNegative();
        System.out.println("2 of 9 tests passed");
        
        testAdditionSmallNumbersOppositeSigns();
        System.out.println("3 of 9 tests passed");

        testAdditionWithNegativeAddendEquivalentToSubtraction();
        System.out.println("4 of 9 tests passed");

        testSubtractionSmallNumbersSameSignsPositive();
        System.out.println("5 of 9 tests passed");

        testSubtractionSmallNumbersSameSignsNegative();
        System.out.println("6 of 9 tests passed");

        testSubtractionOppositeSigns();
        System.out.println("7 of 9 tests passed");

        testSubtractionWithNegativeSubtrahendEquivalentToAddition();
        System.out.println("8 of 9 tests passed");

        testLargeNumbers();
        System.out.println("All 9 of 9 tests passed!");
    }
